...
class CNN(nn.Module):
    def __init__(self, nb_feature = 7, nb_sign = 9,hidden= 832, kWidth = 5, width = 600, nb_sample = 10):
        ...
        conv1sizex , conv1sizey = (1, width//nb_sample-kWidth//2*2)
        pool1sizex, pool1sizey = (1, conv1sizey//2)
        conv2sizex , conv2sizey = (1, pool1sizey-1)
        pool2sizex, pool2sizey = (1, conv2sizey//2)
